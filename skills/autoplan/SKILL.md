...
- Discover design docs: `ls -t .claude/gstack/*-design-*.md 2>/dev/null | head -1`
...
- Test plan: generate artifact at `.claude/gstack/{user}-{branch}-test-plan-{datetime}.md`
...
- [ ] Test plan artifact written to disk at .claude/gstack/
- [ ] "NOT in scope" section written
- [ ] "What already exists" section written
