...
cat .claude/gstack/*-reviews.jsonl 2>/dev/null | grep '"skill":"ship"' | grep '"plan_items_total"' || echo "NO_PLAN_DATA"
```
...
[ -z "$DISCOVER_BIN" ] && [ -x gstack-global-discover ] && DISCOVER_BIN=gstack-global-discover
